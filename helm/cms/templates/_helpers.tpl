...
Define secrets
*/}}
{{- define "cms.externalSecretsName" -}}
{{- printf "%s-external-secrets" ( include "cms.fullname" .) }}
{{/*{{- default "-external-secrets" | cat ( include "cms.fullname" .) | replace " " "" }}*/}}
{{- end}}

{{- define "cms.secretsName" -}}
{{- printf "%s-secrets" ( include "cms.fullname" .) }}
{{- end}}

{{- define "cms.secretsVolumeName" -}}
{{- printf "%s-secrets" ( include "cms.fullname" .) }}
{{- end}}